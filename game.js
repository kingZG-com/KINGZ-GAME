...
koin.src = "files/koin.mp3";
let manuk1 = new Image();
manuk1.src = "files/manuk1.png";
let manuk2 = new Image();
manuk2.src = "files/manuk2.png";
let bg = new Image();
bg.src = "files/bg.jpg";
let gambarTiang = new Image();
gambarTiang.src = "files/tube1.png";
let gambarTiang2 = new Image();
gambarTiang2.src = "files/tube2.png";
const judul = new Image();
judul.src = "files/judull.png";
const gbr = new Image();
gbr.src = "files/mula.png";
const sound = new Audio();
sound.src = "files/remix.mp3";
const go = new Audio();
go.src = "files/over.mp3";
...
main.src = 'files/main.mp3';
const gameO = new Image();
gameO.src = 'files/gameover.png';
const nangis = new Image();
nangis.src = 'files/mn.png';
